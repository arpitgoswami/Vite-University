...
function Contact() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg mt-10">
      ...
      <h2 className="m-4 text-center text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
        Raise a Query
      </h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={handleChange}
            required
            className="mt-2 h-[2.2rem] block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
          >
